module avmm_dma_interchannel #(
    ...
    generate
        ...
        for (i = 0; i < DMA_CHANNEL_COUNT; i += 2) begin : echo_fifos_even
            ...
            stream_fifo #(
                ...
                .data_o  (dma_wrdata_data [i+1]),
                .valid_o (dma_wrdata_valid[i+1]),
                .ready_i (dma_wrdata_ready[i+1]),
                .count_o (dma_wrdata_count[i+1])
            );
        end

        for (i = 1; i < DMA_CHANNEL_COUNT; i += 2) begin : echo_fifos_odd
